          ...
          <Container maxWidth="lg" sx={{ paddingBottom: "75px" }}>
            <Grid container sx={{ mt: "-40px", py: "50px" }}>
              <Grid
                item
                xs={12}
                md={pageInfo.images?.length > 0 ? 6 : 12}
                lg={pageInfo.images?.length > 0 ? 6 : 12}
              >
                {/* <Typography
                variant="subtitle1"
                color="onCard.main"
          ...
          >
            {data?.data?.description}
              ...
              <Grid
                item
                xs={12}
                md={pageInfo.images?.length > 0 ? 6 : 0}
                lg={pageInfo.images?.length > 0 ? 6 : 0}
